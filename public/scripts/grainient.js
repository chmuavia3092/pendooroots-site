// Grainient — WebGL animated gradient (React Bits port, PENDOOROOTS green)
(function() {
  ...
  // Load OGL via dynamic module import
  var link = document.createElement('link');
  link.rel = 'modulepreload';
  link.href = 'https://cdn.jsdelivr.net/npm/ogl@1.0.11/dist/ogl.mjs';
  ...
  import('https://cdn.jsdelivr.net/npm/ogl@1.0.11/dist/ogl.mjs').then(function(mod) {
    ...
    start();
  }).catch(function(e) { console.error('Grainient failed:', e); });
})();
